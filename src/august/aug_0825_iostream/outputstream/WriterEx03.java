...
public class WriterEx03 {
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            OutputStream os = new FileOutputStream("/Users/fbwogur121/Desktop/신세계 I&C/IOStreamEx/temp/test3.db");
            // 데이터 도착지를 test2.db 바이트 출력 스트림 생성

            // 2. 내보낼 데이터를 지정
            byte[] array = {10, 20, 30, 40, 50};

            // 3. 데이터를 스트림에 보내서 해당 목적지에 쓴다. 배열의 인덱스 1부터 시작해 3개 까지만 출력. 즉, 1,2,3번째 인덱스(20, 30, 40)
            os.write(array, 1, 3);
