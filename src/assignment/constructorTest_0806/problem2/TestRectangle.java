package assignment.constructorTest_0806.problem2;
...
public class TestRectangle {
    public static void main(String s[]) {
        ...
        if (rec1.area() > rec2.area()) System.out.println("넓이는 " + rec1.getColor() + " 직사각형이 더 큽니다.");
        else if (rec2.area() > rec1.area()) System.out.println("넓이는 " + rec2.getColor() + " 직사각형이 더 큽니다.");
        else System.out.println("넓이는 같습니다.");
        // TODO 2) 두 직사각형의 둘레를 비교하십시오.
        if (rec1.perimeter() > rec2.perimeter()) System.out.println("둘레는 " + rec1.getColor() + " 직사각형이 더 깁니다.");
        else if (rec2.perimeter() > rec1.perimeter()) System.out.println("둘레는 " + rec2.getColor() + " 직사각형이 더 깁니다.");
